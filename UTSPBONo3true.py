...
# Subclass 'Employee' yang merupakan Subclass dari 'Payable'
...
# Subclass 'Invoice' yang juga merupakan Subclass dari 'Payable'
...
# Subclass 'HourlyEmployee' yang juga merupakan Subclass dari 'Employee'
...
# Subclass 'SalariedEmployee' yang juga merupakan Subclass dari 'Employee'
...
if __name__ == "__main__":
    ...
    salaried_employee = SalariedEmployee("Claire", "Redfield", "555-12-3456", 800)
    base_plus_commission_employee = BasePlusCommissionEmployee("Ada", "Wong", "777-88-9999", 5000, 5, 1000)
    invoice = Invoice("12345", "Widget", 10, 25.0)
